...
export const INTENT_HINTS = [
  ...
  { re: /\b(what keeps going wrong|propose a rule|adopt the lesson|retro the pipeline|graduate the rule|self[- ]improvement loop)\b/, skill: "oc-evolve", phase: "/oc-evolve reflect" },
  { re: /\b(remember this failure|what did we learn|(find )?a similar incident|review (the )?lessons|project memory)\b/, skill: "oc-hindsight", phase: "/oc-hindsight query" },
