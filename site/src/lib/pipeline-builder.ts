...
export const NOT_RECOMMENDED: Record<string, string> = {
  ...
  "oc-evolve":
    "governs rule changes to the opchain pipeline itself from its own outcome history; not driven by what you are building",
  "oc-hindsight":
    "curates lessons from this project's own delivery history; useful once outcomes accumulate, not chosen by product shape",
};
